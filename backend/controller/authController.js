...
export const logOut = async (req, res) => {
  try {
    // ✅ अब दोनों cookies clear करो
    res.clearCookie("user_token", { httpOnly: true, secure: false, sameSite: "Lax", path: '/' });
    res.clearCookie("admin_token", { httpOnly: true, secure: false, sameSite: "Lax", path: '/' });
